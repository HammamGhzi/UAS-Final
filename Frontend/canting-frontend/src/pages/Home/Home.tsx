...
const Home = () => {
  ...
  return (
    ...
    <div className="absolute inset-0 pointer-events-none" />
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-end gap-4">
              <div className="flex-1 text-left">
                ...
                <div className="relative">
                  <MapPin className="absolute left-3.5 top-1/2 -translate-y-1/2 text-black pointer-events-none" size={19} />
                  <select
                    value={wilayah}
                  ...
                  <ChevronDown className="absolute right-3.5 top-1/2 -translate-y-1/2 text-black/45 pointer-events-none" size={16} />
                </div>
              </div>
              ...
              <div className="flex-1 text-left">
                ...
                <div className="relative">
                  <MousePointer2 className="absolute left-3.5 top-1/2 -translate-y-1/2 text-black pointer-events-none" size={19} />
                  <select
                    value={jenisBatik}
      ...
      {/* Sanggar Rekomendasi */}
      <section id="sanggar-section" className="relative min-h-screen min-h-[100svh] min-h-[100dvh] flex flex-col justify-center scroll-mt-0 pt-[clamp(5rem,7vh,6rem)] pb-[clamp(3rem,5vh,4.5rem)] bg-[#f5ead8]">
...
<section className="py-16 px-4 bg-[#f5ead8]">
  <div className="max-w-4xl mx-auto">
    <div className="relative bg-gradient-to-r from-[#f0a854] via-[#f5c98a] to-[#f5ead8] rounded-3xl p-8 md:p-12 overflow-visible min-h-[260px] border border-orange-300/60">
      
      {/* Gambar baju — overflow ke atas */}
      <div className="hidden md:block absolute -top-14 right-16 w-64 z-10">
        <img
          src="/batik-badan.png"
          alt="Promo Batik"
